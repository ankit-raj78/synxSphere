...
async function applyCompositionsMigration() {
    console.log('🔄 Applying compositions table migration...')
    ...
    try {
        ...
        await executeQuery(createCompositionsTable)
        console.log('✅ Compositions table created')
        ...
        await executeQuery(createAnalysisTable)
        ...
        console.log('🎉 Compositions migration completed successfully!')
